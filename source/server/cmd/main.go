...
func main() {
	...
	originsOk := handlers.AllowedOrigins([]string{"http://localhost:8080", "http://localhost:80", "http://localhost", "http://127.0.0.1:8080", "http://127.0.0.1", "http://127.0.0.1:80", "http://wegonice-frontend:80", "http://wegonice-frontend"})
